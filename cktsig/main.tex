...
\begin{lstlisting}
https://github.com/gaureeshk/sig/cktsig/codes/e3.4.py
\end{lstlisting}
\item Verify your result using ngspice.\\
\solution
\begin{figure}[!htb]
...
\begin{lstlisting}
https://github.com/gaureeshk/sig/cktsig/codes/e3.cir
\end{lstlisting}
\item Find $v_{C_0}(0-), v_{C_0}(0+)$ and  $v_{C_0}(\infty) $.\\
\solution
\begin{align}
	v_{C_0}(0-) = \lim_{t \to 0-}v_{C_0}(t) = \frac{q_1}{C} = \frac{4}{3}\text{ V}\\
	v_{C_0}(0+) = \lim_{t \to 0+}v_{C_0}(t) 
	= \frac{4}{3} V
\end{align}
\begin{align}
...
\begin{figure}[!htb]
	\begin{center}
		\begin{circuitikz} 
			...
			to[battery1, l^= 2\text{V}] (5.5,0)
			-- (0,0) (3,3) to[battery1, l=$\frac{4}{3} V$] (3,2) to[C,l=$C_0$,i= $i_2$] (3,0) ;
		\end{circuitikz}
	\end{center}
	\caption{}
	\label{fig:tckt-q2}
...
\begin{lstlisting}
https://github.com/gaureeshk/sig/cktsig/codes/e4.3.py
\end{lstlisting}
\begin{figure}[!ht]
...
\begin{lstlisting}
https://github.com/gaureeshk/sig/cktsig/codes/e4.7.py
\end{lstlisting}
\begin{figure}[!ht]
	\begin{center}
