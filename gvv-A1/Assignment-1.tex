...
\author{GIDUTURI YUGANDHAR VASUDEV - EP20BTECH11006}
\maketitle
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/SoundFiles/Sound_Noise.wav
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/2.3_noise.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/3.1.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 3.1.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes//3.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 3.2.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/3.3.c
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/3.3_plot.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	gcc 3.3.c -o 3.3.out
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/4.5.py
\end{lstlisting}
run the above code using the command 
\begin{lstlisting}
	python3 4.5.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.1.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.2.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.2.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.6.py
\end{lstlisting}
...
%
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.4.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.4.py
...
%
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.5.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 5.5.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/5.9.py
\end{lstlisting}
...
%
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/6.1.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.1.py
...
%
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/6.2.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.2.py
...
%
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/6.3.py
\end{lstlisting}
run the above code using the command.
\begin{lstlisting}
	python3 6.3.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/6.4.py
\end{lstlisting}
...
\solution Download the code from
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/6.6.py
\end{lstlisting}
and execute it using
\begin{lstlisting}
$ python3 6.6.py
...
\solution Download the code from
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/7.1.py
\end{lstlisting}
and execute it using
\begin{lstlisting}
$ python3 7.1.py
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/7.2.1.py
\end{lstlisting}
The filter frequency response is plotted at
\begin{lstlisting}
	wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/7.2.2.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/YugandharVasudevG/EE3900/tree/main/Codes/7.2.3.py
\end{lstlisting}
